...
public class tester extends LinearOpMode {
    ...
    public void Step17(double power, int distance, int timeoutS){
        DriveFor(power, distance, timeoutS);
    }
    ...
    public void DriveFor(double power, int distance, int timeoutS){       //reset encoders
        ...
        ResetEncoders();
        //set target position
        SetTargetPosition(distance*10);//set to Run to position mode
        SetToRunToPosition();
        //drive at power
        DriveForward(power);
